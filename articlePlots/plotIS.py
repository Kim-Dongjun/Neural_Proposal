...
filenames = ['Inception_Score_performance']
...
plt.tight_layout()
#plt.show()
plt.savefig('D:\Research\논문\Sequential_Likelihood_Free_Inference_with_Surrogate_Proposal\AISTATS21\imgs/complexPosterior16_IS_resize.pdf')
