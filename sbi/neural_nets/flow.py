...
def build_maf(
    ...
    **kwargs,
        ...
        [
            transforms.CompositeTransform(
                [
                    ...
                    transforms.RandomPermutation(features=x_numel, device=device),
                ]
            )
    ...
    distribution = distributions_.StandardNormal((x_numel,), device)
...
def build_nsf(
    ...
    **kwargs,
    ...
    #print("x_numel, y_numel : ", x_numel, y_numel)
    ...
    if z_score_y:
        embedding_net = nn.Sequential(standardizing_net(batch_y), embedding_net).to(device)
